### [统计直线 + 去掉重复统计的平行四边形，附思考题（Python/Java/C++/Go）](https://leetcode.cn/problems/count-number-of-trapezoids-ii/solutions/3728529/tong-ji-zhi-xian-qu-diao-zhong-fu-tong-j-a3f9/)

#### 核心思路

1. 本题 $n\le 500$，我们可以 $O(n^2)$ 枚举所有点对组成的直线，计算直线的斜率和截距。
...
对于两个点 $(x,y)$ 和 $(x_2,y_2)$，设 $dx=x-x_2$，dy=y-y_2。

经过这两个点的斜率为

$$k=\begin{cases}\dfrac{dy}{dx}, & dx\ne 0 \\ \infty, & dx=0\end{cases}$$

当 $dx\ne 0$ 时，设直线为 $Y=k\cdot X+b$，把 $(x,y)$ 代入，解得截距

$$b=y-k\cdot x=\dfrac{y\cdot dx-x\cdot dy}{dx}$$

当 $dx=0$ 时，直线平行于 $y$ 轴，人为规定 $b=x$，用来区分不同的平行线。
...
具体请看 [视频讲解](https://leetcode.cn/link/?target=https%3A%2F%2Fwww.bilibili.com%2Fvideo%2FBV1tbg8z3EaP%2F%3Ft%3D34m29s)，欢迎点赞关注~
