### [环绕字符串中唯一的子字符串](https://leetcode.cn/problems/unique-substrings-in-wraparound-string/solutions/1514359/huan-rao-zi-fu-chuan-zhong-wei-yi-de-zi-ndvea/?envType=problem-list-v2&envId=ySsxoJfz)
...
$$\sum\limits_{\alpha ='a'}^{'z'}dp[\alpha]$$
...
- 空间复杂度：$O(\vert \sum \vert )$，其中 $\vert \sum \vert $ 为字符集合的大小，本题中字符均为小写字母，故 $\vert \sum \vert =26$。
