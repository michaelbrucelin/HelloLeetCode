#### [概述](https://leetcode.cn/problems/design-hashset/solutions/652778/she-ji-ha-xi-ji-he-by-leetcode-solution-xp4t/)
...
#### [方法一：链地址法](https://leetcode.cn/problems/design-hashset/solutions/652778/she-ji-ha-xi-ji-he-by-leetcode-solution-xp4t/)

设哈希表的大小为 $base$，则可以设计一个简单的哈希函数：$hash(x) = x \bmod base$。

我们开辟一个大小为 $base$ 的数组，数组的每个位置是一个链表。当计算出哈希值之后，就插入到对应位置的链表当中。

由于我们使用整数除法作为哈希函数，为了尽可能避免冲突，应当将 $base$ 取为一个质数。在这里，我们取 $base = 769$。

![](./assets/img/Solution0705_3_01.png)
