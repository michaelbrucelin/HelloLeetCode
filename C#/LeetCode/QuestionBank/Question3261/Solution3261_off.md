### [统计满足 K 约束的子字符串数量 II](https://leetcode.cn/problems/count-substrings-that-satisfy-k-constraint-ii/solutions/2976328/tong-ji-man-zu-k-yue-shu-de-zi-zi-fu-chu-f4kb/?envType=daily-question&envId=2024-11-13)
...
1. 右端点在 $i=right[l]$ 之前的子字符串全都满足 $k$ 约束，总共数量为 $(i-l+1)∗(i-l)/2$。
