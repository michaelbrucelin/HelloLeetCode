### [O(1) 时间插入、删除和获取随机元素 - 允许重复](https://leetcode.cn/problems/insert-delete-getrandom-o1-duplicates-allowed/solutions/467591/o1-shi-jian-cha-ru-shan-chu-he-huo-qu-sui-ji-yua-5/)
...
这需要我们额外维护数值在列表中**每一次**出现的下标集合。对于数值 $val$ 而言，记其下标集合为 $S_{idx}$。
