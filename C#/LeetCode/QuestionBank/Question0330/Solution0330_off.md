### [按要求补齐数组](https://leetcode.cn/problems/patching-array/solutions/538939/an-yao-qiu-bu-qi-shu-zu-by-leetcode-solu-klp1/?envType=problem-list-v2&envId=ySsxoJfz)
...
- 如果 $index$ 在数组 $nums$ 的下标范围内且 $nums[index]\le x$，则将 $nums[index]$ 的值加给 $x$，并将 $index$ 的值加 $1$。
