### [双堆模拟（Python/Java/C++/Go）](https://leetcode.cn/problems/meeting-rooms-iii/solutions/1799420/shuang-dui-mo-ni-pythonjavacgo-by-endles-ctwc/)
...
- 时间复杂度：$O(m\log m+n+m\log n)$，其中 $m$ 是 $meetings$ 的长度。注意每个会议至多入堆出堆各一次。
- 空间复杂度：$O(n)$。
