### [转换问题+最小堆（Python/Java/C++/Go/JS/Rust）](https://leetcode.cn/problems/maximum-subsequence-score/solutions/2073033/zhuan-huan-wen-ti-zui-xiao-dui-by-endles-9t8t/?envType=problem-list-v2&envId=ySsxoJfz)

**请记住：有序是一个非常好的性质。**

把 $nums_1$ 和 $nums_2$ 组合起来，按照 $nums_2[i]$ 从大到小排序。枚举 $nums_2[i]$ 作为序列的最小值，那么 $nums_1$ 就只能在下标 $\le i$ 的数中选了。要选最大的 $k$ 个数。
...
[视频讲解](https://leetcode.cn/link/?target=https%3A%2F%2Fwww.bilibili.com%2Fvideo%2FBV1jG4y197qD%2F) 第三题。
...
- 时间复杂度：$O(n\log n)$，其中 $n$ 为 $nums_1$ 的长度。
- 空间复杂度：$O(n)$。
