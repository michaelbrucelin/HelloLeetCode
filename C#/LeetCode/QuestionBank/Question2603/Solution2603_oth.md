### [拓扑排序（Python/Java/C++/Go/JS/Rust）](https://leetcode.cn/problems/collect-coins-in-a-tree/solutions/2191371/tuo-bu-pai-xu-ji-lu-ru-dui-shi-jian-pyth-6uli/)
...
-   时间复杂度：$\mathcal{O}(n)$，其中 $n$ 为 $coins$ 的长度。
-   空间复杂度：$\mathcal{O}(n)$。
