### [最小操作次数使数组元素相等](https://leetcode.cn/problems/minimum-moves-to-equal-array-elements/solutions/1054870/zui-xiao-cao-zuo-ci-shu-shi-shu-zu-yuan-3meg3/?envType=problem-list-v2&envId=ySsxoJfz)
...
$$\sum\limits_{i=0}^{n-1}(nums[i]-min(nums))$$
