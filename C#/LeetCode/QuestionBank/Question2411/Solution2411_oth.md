### [从 $O(n\log U)$ 到 $O(n)$：LogTrick / 滑动窗口 + 栈（Python/Java/C++/C/Go/JS/Rust）](https://leetcode.cn/problems/smallest-subarrays-with-maximum-bitwise-or/solutions/1830911/by-endlesscheng-zai1/)
