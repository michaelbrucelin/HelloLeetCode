### [等价转换 + 定长滑动窗口 + 优化（Python/Java/C++/Go）](https://leetcode.cn/problems/distinct-points-reachable-after-substring-removal/solutions/3793905/deng-jie-zhuan-huan-ding-chang-hua-dong-3b67r/?envType=problem-list-v2&envId=ySsxoJfz)
...
也就是对 $s$ 的长为 $k$ 的子串，计算 $UDLR$ 偏移量之和。
...
[本题视频讲解](https://leetcode.cn/link/?target=https%3A%2F%2Fwww.bilibili.com%2Fvideo%2FBV1AKnRz8Ejn%2F%3Ft%3D5m31s)，欢迎点赞关注~
...
- 空间复杂度：$O(n-k)$。有 $n-k+1$ 个窗口，所以哈希表中至多保存 $n-k+1$ 个不同坐标。
...
- 时间复杂度：$O(n-k)$，其中 $n$ 是 $s$ 的长度。
- 空间复杂度：$O(n-k)$。有 $n-k+1$ 个窗口，所以哈希表中至多保存 $n-k+1$ 个不同坐标。

#### 变形题

- [CF1296C](https://leetcode.cn/link/?target=https%3A%2F%2Fcodeforces.com%2Fproblemset%2Fproblem%2F1296%2FC)
- [CF1902D](https://leetcode.cn/link/?target=https%3A%2F%2Fcodeforces.com%2Fproblemset%2Fproblem%2F1902%2FD)
