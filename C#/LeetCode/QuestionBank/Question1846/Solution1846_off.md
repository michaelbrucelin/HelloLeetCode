### [减小和重新排列数组后的最大元素](https://leetcode.cn/problems/maximum-element-after-decreasing-and-rearranging/solutions/754917/jian-xiao-he-zhong-xin-pai-lie-shu-zu-ho-mzee/)
...
impl Solution {
    pub fn maximum_element_after_decrementing_and_rearranging(arr: Vec<i32>) -> i32 {
        ...
        for v in arr {
            cnt[std::cmp::min(v as usize, n)] += 1;
        }
        ...
        for i in 1..=n {
            if cnt[i] == 0 {
                ...
                miss -= std::cmp::min(cnt[i] - 1, miss); // miss 不会小于 0，故至多减去 miss 个元素
            }
        }
