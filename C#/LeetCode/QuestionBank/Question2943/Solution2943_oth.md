### [不排序，线性时间复杂度（Python/Java/C++/Go）](https://leetcode.cn/problems/maximize-area-of-square-hole-in-grid/solutions/2542812/heng-shu-fen-bie-tong-ji-fen-zu-xun-huan-nboj/)
...
- 时间复杂度：$O(h\log h+v\log v)$，其中 $h$ 为 $hBars$ 的长度，$v$ 为 $vBars$ 的长度。
- 空间复杂度：$O(1)$。忽略排序的栈开销。
