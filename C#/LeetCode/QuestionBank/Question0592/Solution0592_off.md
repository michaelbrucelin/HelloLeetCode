### [分数加减运算](https://leetcode.cn/problems/fraction-addition-and-subtraction/solutions/1699131/fen-shu-jia-jian-yun-suan-by-leetcode-so-2mto/?envType=problem-list-v2&envId=ySsxoJfz)
...
初始分数的分子为 $x=0$，分母为 $y=1$。我们不断从字符串中获取下一个分数，它的分子为 $x_1$，分母为 $y_1$，将它加到初始分数上，有：

$$\begin{cases}x=x\times y_1+x_1\times y \\ y=y\times y_1\end{cases}$$
