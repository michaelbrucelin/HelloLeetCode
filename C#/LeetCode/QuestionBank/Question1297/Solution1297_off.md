### [子串的最大出现次数](https://leetcode.cn/problems/maximum-number-of-occurrences-of-a-substring/solutions/101811/zi-chuan-de-zui-da-chu-xian-ci-shu-by-leetcode-sol/?envType=problem-list-v2&envId=ySsxoJfz)
...
- 时间复杂度：$O(NS)$，其中 $N$ 是字符串的长度，$S$ 是 `minSize` 的大小。
- 空间复杂度：$O(NS)$。
...
关于「滚动哈希」或「Rabin-Karp 算法」的知识，可以参考 [1044\. 最长重复子串的官方题解](https://leetcode.cn/problems/longest-duplicate-substring/solution/zui-chang-zhong-fu-zi-chuan-by-leetcode/) 或使用搜索引擎，这里对算法本身的流程不再赘述。
