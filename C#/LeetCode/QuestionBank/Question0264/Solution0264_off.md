### [丑数 II](https://leetcode.cn/problems/ugly-number-ii/solutions/712102/chou-shu-ii-by-leetcode-solution-uoqd/?envType=problem-list-v2&envId=ySsxoJfz)
...
![](./assets/img/Solution0264_off_1_01.png)
![](./assets/img/Solution0264_off_1_02.png)
![](./assets/img/Solution0264_off_1_03.png)
![](./assets/img/Solution0264_off_1_04.png)
![](./assets/img/Solution0264_off_1_05.png)
![](./assets/img/Solution0264_off_1_06.png)
![](./assets/img/Solution0264_off_1_07.png)
![](./assets/img/Solution0264_off_1_08.png)
![](./assets/img/Solution0264_off_1_09.png)
![](./assets/img/Solution0264_off_1_10.png)
![](./assets/img/Solution0264_off_1_11.png)
![](./assets/img/Solution0264_off_1_12.png)
...
当 $2\le i\le n$ 时，令 $dp[i]=min(dp[p_2]\times 2,dp[p_3]\times 3,dp[p_5]\times 5)$，然后分别比较 $dp[i]$ 和 $dp[p_2]\times 2,dp[p_3]\times 3,dp[p_5]\times 5$ 是否相等，如果相等则将对应的指针加 $1$。

**正确性证明**

对于 $i>1$，在计算 $dp[i]$ 时，指针 $p_x(x\in {2,3,5})$ 的含义是使得 $dp[j]\times x>dp[i-1]$ 的最小的下标 $j$，即当 $j\ge p_x$ 时 $dp[j]\times x>dp[i-1]$，当 $j<p_x$ 时 $dp[j]\times x\le dp[i-1]$。

因此，对于 $i>1$，在计算 $dp[i]$ 时，$dp[p_2]\times 2,dp[p_3]\times 3,dp[p_5]\times 5$ 都大于 $dp[i-1]$，dp[p_2-1]\times $2,dp[p_3-1]\times 3,dp[p_5-1]\times 5$ 都小于或等于 $dp[i-1]$。令 $dp[i]=min(dp[p_2]\times 2,dp[p_3]\times 3,dp[p_5]\times 5)$，则 $dp[i]>dp[i-1]$ 且 $dp[i]$ 是大于 $dp[i-1]$ 的最小的丑数。

在计算 $dp[i]$ 之后，会更新三个指针 $p_2,p_3,p_5$，更新之后的指针将用于计算 $dp[i+1]$，同样满足 $dp[i+1]>dp[i]$ 且 $dp[i+1]$ 是大于 $dp[i]$ 的最小的丑数。

![](./assets/img/Solution0264_off_2_01.png)
![](./assets/img/Solution0264_off_2_02.png)
![](./assets/img/Solution0264_off_2_03.png)
![](./assets/img/Solution0264_off_2_04.png)
![](./assets/img/Solution0264_off_2_05.png)
