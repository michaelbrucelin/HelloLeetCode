### [将二进制表示减到 1 的步骤数](https://leetcode.cn/problems/number-of-steps-to-reduce-a-number-in-binary-representation-to-one/solutions/202251/jiang-er-jin-zhi-biao-shi-jian-dao-1-de-bu-zou-shu/)
        ...
        if (str[current_len - 1] == '0') {
            ...
            for (int i = current_len - 1; i >= 0; --i) {
                if (str[i] == '1') {
                    str[i] = '0';
                    if (i == 0) {
                        memmove(str + 1, str, current_len + 1);
                        str[0] = '1';
                        found = true;
                        break;
                    }
