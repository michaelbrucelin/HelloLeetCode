### [石子游戏 IV](https://leetcode.cn/problems/stone-game-iv/solutions/336443/shi-zi-you-xi-iv-by-leetcode-solution/)
...
$$f[i]=\begin{cases}true, & any f[i-k^2] is false where 1\le k^2\le i \\ false, & otherwise\end{cases}$$
