### [拓扑排序+动态规划（Python/Java/C++/Go/JS）](https://leetcode.cn/problems/parallel-courses-$i$/solutions/1063928/tuo-bu-pai-xu-dong-tai-gui-hua-by-endles-dph6/)
...
-   时间复杂度：$\mathcal{O}(n+m)$，其中 $m$ 为 $relations$ 的长度。
-   空间复杂度：$\mathcal{O}(n+m)$。
