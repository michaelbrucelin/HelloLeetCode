### [考试的最大困扰度](https://leetcode.cn/problems/maximize-the-confusion-of-an-exam/solutions/1368825/kao-shi-de-zui-da-kun-rao-du-by-leetcode-qub5/)
...
在指定字符的情况下，我们可以计算其最大连续数目。具体地，我们使用滑动窗口的方法，从左到右枚举右端点，维护区间中另一种字符的数量为 $sum$，当 $sum$ 超过 $k$，我们需要让左端点右移，直到 $sum≤ \le k$。移动过程中，我们记录滑动窗口的最大长度，即为指定字符的最大连续数目。
