...
存在一个 <code>n &times; n</code> 大小、下标从 **0** 开始的网格，网格中埋着一些工件。给你一个整数 `n` 和一个下标从 *&times;0&times;&times; 开始的二维整数数组 `artifacts`，`artifacts` 描述了矩形工件的位置，其中 <code>artifacts[i] = [r1<sub>i</sub>, c1<sub>i</sub>, r2<sub>i</sub>, c2<sub>i</sub>]</code> 表示第 `i` 个工件在子网格中的填埋情况：
...
> ![](./assets/img/Question2201_01.jpg)
...
> ![](./assets/img/Question2201_02.jpg)
