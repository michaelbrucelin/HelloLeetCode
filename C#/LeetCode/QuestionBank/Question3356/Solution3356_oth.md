### [三种方法：二分答案+差分数组 $/ Lazy$ 线段树 $/$ 双指针（$Python/Java/C++/Go$）](https://leetcode.cn/problems/zero-array-transformation-ii/solutions/1/liang-chong-fang-fa-er-fen-da-an-chai-fe-rcvg/)
