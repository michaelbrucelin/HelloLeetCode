### [优质数对的总数 I](https://leetcode.cn/problems/find-the-number-of-good-pairs-i/solutions/2935680/you-zhi-shu-dui-de-zong-shu-i-by-leetcod-yvvm/)
...
- 时间复杂度：$O(n \times m)$，其中 $n$ 和 $m$ 分别是数组 $nums1$​ 和 $nums2$​ 的长度
- 空间复杂度：$O(1)$。
