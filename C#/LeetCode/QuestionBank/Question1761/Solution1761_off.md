### [一个图中连通三元组的最小度数](https://leetcode.cn/problems/minimum-degree-of-a-connected-trio-in-a-graph/solutions/2417898/yi-ge-tu-zhong-lian-tong-san-yuan-zu-de-wuv8o/)
...
-   如果 $degree(i) = degree(j)$，那么边的方向由编号较小的节点指向编号较大的节点。
...
-   时间复杂度：$O(n + m \sqrt{m})$，其中 $m$ 是数组 $edges$ 的长度。
