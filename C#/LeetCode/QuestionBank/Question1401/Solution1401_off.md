### [圆和矩形是否有重叠](https://leetcode.cn/problems/circle-and-rectangle-overlapping/solutions/2293443/yuan-he-ju-xing-shi-fou-you-zhong-die-by-zlbk/)
...
圆心到矩形区域的最小距离就是 $\sqrt{x_{\min}^2 + y_{\min}^2}$。为了方便理解，我们可以把平面区域根据 $x = x_1$、$x = x_2$、$y = y_1$、$y = y_2$ 四条直线分割成九个区域，分类讨论就可以合并到这个结果。
