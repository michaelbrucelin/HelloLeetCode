### [四因数](https://leetcode.cn/problems/four-divisors/solutions/166486/si-yin-shu-by-leetcode-solution/?envType=problem-list-v2&envId=tBJHVASZ)
...
- [算数基本定理](https://leetcode.cn/link/?target=https%3A%2F%2Fbaike.baidu.com%2Fitem%2F%E7%AE%97%E6%9C%AF%E5%9F%BA%E6%9C%AC%E5%AE%9A%E7%90%86)
- [埃拉托斯特尼筛法](https://leetcode.cn/link/?target=https%3A%2F%2Fbaike.baidu.com%2Fitem%2F%E5%9F%83%E6%8B%89%E6%89%98%E6%96%AF%E7%89%B9%E5%B0%BC%E7%AD%9B%E6%B3%95) 或更高级的欧拉筛法
...
$$factor\_count(x)=\mathop{\Pi}\limits_{i=1}^k(\alpha_i+1)$$

如果 $factor\_count(x)$ 的值为 $4$，那么只有两种可能：

- 整数 $x$ 只有一个质因数，对应的指数为 $3$，此时 $factor\_count(x)=(3+1)=4$；
- 整数 $x$ 有两个质因数，对应的指数均为 $1$，此时 $factor\_count(x)=(1+1)(1+1)=4$。
