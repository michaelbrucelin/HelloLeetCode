### [统计按位或能得到最大值的子集数目](https://leetcode.cn/problems/count-number-of-maximum-bitwise-or-subsets/solutions/1335667/tong-ji-an-wei-huo-neng-de-dao-zui-da-zh-r6zd/)
...
- 时间复杂度：$O(2^n)$，其中 $n$ 是数组 $nums$ 的长度。状态数一共有 $O(2^0+2^1+\dots +2n)=O(2\times 2^n)=O(2^n)$ 种，每次计算只消耗常数时间。
