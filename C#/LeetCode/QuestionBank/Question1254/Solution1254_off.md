#### [方法一：广度优先搜索](https://leetcode.cn/problems/number-of-closed-islands/solutions/2311536/tong-ji-feng-bi-dao-yu-de-shu-mu-by-leet-ofh3/)
...
#### [方法二：深度优先搜索](https://leetcode.cn/problems/number-of-closed-islands/solutions/2311536/tong-ji-feng-bi-dao-yu-de-shu-mu-by-leet-ofh3/)
...
#### [方法三：并查集](https://leetcode.cn/problems/number-of-closed-islands/solutions/2311536/tong-ji-feng-bi-dao-yu-de-shu-mu-by-leet-ofh3/)
...
遍历结束之后，我们利用哈希表统计所有陆地元素构成的连通集合的数目为 $total$，此时还需要检测边界集合 $0$ 是否也包含在 $total$ 中，如果 $total$ 包含边界集合 $0$ 中，则返回 $total - 1$，否则返回 $total$。
