### [两种方法：二维前缀和模板 / 维护每列元素和（Python/Java/C++/Go）](https://leetcode.cn/problems/count-submatrices-with-top-left-element-and-sum-less-than-k/solutions/2664654/mo-ban-er-wei-qian-zhui-he-pythonjavacgo-fnk1/)
...
**注**：如果把每列元素和保存到 $grid$ 的第一行，可以做到 $O(1)$ 额外空间。
