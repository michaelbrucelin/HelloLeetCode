### [替换字符串中的括号内容](https://leetcode.cn/problems/evaluate-the-bracket-pairs-of-a-string/solutions/2055952/ti-huan-zi-fu-chuan-zhong-de-gua-hao-nei-y8d3/)
...
- 如果 $c$ 等于 ‘(’
    说明之后的小写字母是在括号内的，令 $addKey=true$。
- 如果 $c$ 等于 ‘)’
    说明 $key$ 已经结束，如果 $key$ 在 $dict$ 中，我们将 $dict[key]$ 附加到结果字符串中，否则将字符 ‘?’ 附加到结果字符串中。清除字符串 $key$，令 $addKey=false$。
- 如果 $c$ 是小写字母
