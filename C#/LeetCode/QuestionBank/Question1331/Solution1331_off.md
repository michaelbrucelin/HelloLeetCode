### [数组序号转换](https://leetcode.cn/problems/rank-transform-of-an-array/solutions/1701490/shu-zu-xu-hao-zhuan-huan-by-leetcode-sol-8zlu/)
...
- 时间复杂度：$O(n\times \log n)$，其中 $n$ 是输入数组 $arr$ 的长度，排序消耗 $O(n\times \log n)$ 时间。
