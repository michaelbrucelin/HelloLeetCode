### [水壶问题](https://leetcode.cn/problems/water-and-jug-problem/solutions/161010/shui-hu-wen-ti-by-leetcode-solution/?envType=daily-question&envId=2024-01-28)
...
预备知识：[贝祖定理](https://leetcode.cn/link/?target=https%3A%2F%2Fbaike.baidu.com%2Fitem%2F%E8%A3%B4%E8%9C%80%E5%AE%9A%E7%90%86%2F5186593%3Ffromtitle%3D%E8%B4%9D%E7%A5%96%E5%AE%9A%E7%90%86%26fromid%3D5185441)
...
- 若 $a\lt 0$，那么可以进行以下操作：
    1. 往 `y` 壶倒水；
    1. 把 `y` 壶的水倒入 `x` 壶；
    1. 如果 `y` 壶不为空，那么 `x` 壶肯定是满的，把 `x` 壶倒空，然后再把 `y` 壶的水倒入 `x` 壶。
