...
![](./assets/img/Solution3121_oth.png)
...
请看 [视频讲解](https://leetcode.cn/link/?target=https%3A%2F%2Fwww.bilibili.com%2Fvideo%2FBV1gu4m1F7B8%2F) 第二题，欢迎点赞关注！
...
- 时间复杂度：$O(n+\vert \sum \vert)$，其中 $n$ 为 $word$ 的长度，$\vert \sum \vert$ 为字符集合的大小，本题字符均为英文字母，所以 $\vert \sum \vert =26$。
- 空间复杂度：$O(\vert \sum \vert)$。

## 方法二：位运算

我们可以把小写字母加到集合 $lower$ 中，大写字母（转成小写后）加到集合 $upper$ 中。如果遍历到小写字母 $c$ 时，发现 $c$ 也在 $upper$ 中，说明大写字母在小写字母前面，把 $c$ 加到集合 $invalid$ 中。
