#### [方法一：枚举](https://leetcode.cn/problems/powerful-integers/solutions/2252454/qiang-zheng-shu-by-leetcode-solution-0lzr/)
...
-   时间复杂度：$O(\log^2(bound))$，双层循环的时间复杂度是 $O(\log^2(bound))$。
