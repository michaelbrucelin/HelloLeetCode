### [O(nlogn) 线段树做法（Python/Java/C++/Go）](https://leetcode.cn/problems/subarrays-distinct-element-sum-of-squares-i/solutions/2502928/onlogn-xian-duan-shu-zuo-fa-pythonjavacg-pd8r/)
