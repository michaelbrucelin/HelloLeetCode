### [替换后的最长重复字符](https://leetcode.cn/problems/longest-repeating-character-replacement/solutions/586648/ti-huan-hou-de-zui-chang-zhong-fu-zi-fu-eaacp/)
...
- 空间复杂度：$O(A)$，这里 $A$ 是输入字符串 `S` 出现的字符 $ASCII$ 值的范围（感谢用户 [@hyponarch](https://leetcode.cn/u/hyponarch/) 指正）。
