### [最长公共子序列](https://leetcode.cn/problems/longest-common-subsequence/solutions/696763/zui-chang-gong-gong-zi-xu-lie-by-leetcod-y7u0/)
...
- 当 $text_1[i-1]\ne text_2[j-1]$ 时，考虑以下两项：
  - text_1[0:i-1]$ 和 $text_2[0:j-2]$ 的最长公共子序列；
  - text_1[0:i-2]$ 和 $text_2[0:j-1]$ 的最长公共子序列。
...
![](./assets/img/Solution1143_off.png)
