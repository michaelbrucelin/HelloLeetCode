### [两种方法：枚举全排列 / 最小费用最大流（Python/Java/C++/Go/JS）](https://leetcode.cn/problems/minimum-moves-to-spread-stones-over-grid/solutions/2435313/tong-yong-zuo-fa-zui-xiao-fei-yong-zui-d-iuw8/)
