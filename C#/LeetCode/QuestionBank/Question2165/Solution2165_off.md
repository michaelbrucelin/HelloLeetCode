### [重排数字的最小值](https://leetcode.cn/problems/smallest-value-of-the-rearranged-number/solutions/1249234/zhong-pai-shu-zi-de-zui-xiao-zhi-by-leet-p06c/?envType=problem-list-v2&envId=ySsxoJfz)
...
- 时间复杂度：$O(\log num\log \log num)$，即为排序需要的时间。$num$ 包含的数字个数为 $O(\log num)$。
- 空间复杂度：$O(\log num)$，即为存储 $num$ 包含的数字需要使用的空间。
