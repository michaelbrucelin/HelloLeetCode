### [两种方法：二维前缀和/维护每列字符个数（Python/Java/C++/Go）](https://leetcode.cn/problems/count-submatrices-with-equal-frequency-of-x-and-y/solutions/2833801/liang-chong-fang-fa-er-wei-qian-zhui-he-a6qqf/)

#### 方法一：二维前缀和

请看[【图解】二维前缀和](https://leetcode.cn/problems/range-sum-query-2d-immutable/solution/tu-jie-yi-zhang-tu-miao-dong-er-wei-qian-84qp/) 以及 [视频讲解](https://leetcode.cn/link/?target=https%3A%2F%2Fwww.bilibili.com%2Fvideo%2FBV14r421W7oR%2F)。
...
遍历每一行，同时用一个长为 $n\times 2$ 的数组 $colCnt$ 维护每一列的 $X$ 和 $Y$ 的个数。

遍历当前行时，一边更新 $colCnt[j]$，一边累加 $colCnt[j][0]$ 到变量 $s0$ 中，累加 $colCnt[j][1]$ 到变量 $s1$ 中。

具体请看 [视频讲解](https://leetcode.cn/link/?target=https%3A%2F%2Fwww.bilibili.com%2Fvideo%2FBV1Ry411q71f%2F) 第三题，欢迎点赞关注！
