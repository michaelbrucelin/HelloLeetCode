...
![](./assets/img/Solution0116_off_1_01.png)
![](./assets/img/Solution0116_off_1_02.png)
![](./assets/img/Solution0116_off_1_03.png)
![](./assets/img/Solution0116_off_1_04.png)
![](./assets/img/Solution0116_off_1_05.png)
![](./assets/img/Solution0116_off_1_06.png)
![](./assets/img/Solution0116_off_1_07.png)
![](./assets/img/Solution0116_off_1_08.png)
![](./assets/img/Solution0116_off_1_09.png)
![](./assets/img/Solution0116_off_1_10.png)
![](./assets/img/Solution0116_off_1_11.png)
![](./assets/img/Solution0116_off_1_12.png)
![](./assets/img/Solution0116_off_1_13.png)
![](./assets/img/Solution0116_off_1_14.png)
![](./assets/img/Solution0116_off_1_15.png)
...
1.  第一种情况是连接同一个父节点的两个子节点。它们可以通过同一个节点直接访问到，因此执行下面操作即可完成连接。
    ...
    ```
    ![](./assets/img/Solution0116_off_2_01.png)
2.  第二种情况在不同父亲的子节点之间建立连接，这种情况不能直接连接。
    ![](./assets/img/Solution0116_off_2_02.png)
...
3.  上面思路的伪代码如下：
    ...
    ```
    ![](./assets/img/Solution0116_off_2_03.png)
4.  两种类型的 $next$ 指针。
    1.  第一种情况两个子节点属于同一个父节点，因此直接通过父节点建立两个子节点的 $next$ 指针即可。
        ```python
        node.left.next = node.right
        ```
    ![](./assets/img/Solution0116_off_2_04.png)
    2.  第二种情况是连接不同父节点之间子节点的情况。更具体地说，连接的是第一个父节点的右孩子和第二父节点的左孩子。由于已经在父节点这一层建立了 $next$ 指针，因此可以直接通过第一个父节点的 $next$ 指针找到第二个父节点，然后在它们的孩子之间建立连接。
        ...
        ```
    ![](./assets/img/Solution0116_off_2_05.png)
5.  完成当前层的连接后，进入下一层重复操作，直到所有的节点全部连接。进入下一层后需要更新最左节点，然后从新的最左节点开始遍历该层所有节点。因为是完美二叉树，因此最左节点一定是当前层最左节点的左孩子。如果当前最左节点的左孩子不存在，说明已经到达该树的最后一层，完成了所有节点的连接。
    ![](./assets/img/Solution0116_off_2_06.png)
