### [链表随机节点](https://leetcode.cn/problems/linked-list-random-node/solutions/1210211/lian-biao-sui-ji-jie-dian-by-leetcode-so-x6it/?envType=problem-list-v2&envId=h15Gc5qm)
...
$$\begin{array}{rl}
    ...
    = & P(第 i 次随机选择的值=0)\times P(第 i+1 次随机选择的值\ne 0)\times \dots \times P(第 n 次随机选择的值\ne 0)\\
    = & \dfrac{1}{i}\times (1-\dfrac{1}{i+1})\times \dots \times (1-\dfrac{1}{n})\\
    = & \dfrac{1}{i}\times \dfrac{i}{i+1}\times \dots \times \dfrac{n-1}{n}\\
    = & \dfrac{1}{n}
\end{array}$$
