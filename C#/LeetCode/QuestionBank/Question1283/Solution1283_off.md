### [使结果不超过阈值的最小除数](https://leetcode.cn/problems/find-the-smallest-divisor-given-a-threshold/solutions/101358/shi-jie-guo-bu-chao-guo-yu-zhi-de-zui-xiao-chu-s-3/?envType=problem-list-v2&envId=ySsxoJfz)
...
- 时间复杂度：$O(N\log C)$，其中 $C$ 是一个常数，为二分查找的上下限之差。在本题给定的数据范围的限制下，$C$ 不会超过 $106$。
- 空间复杂度：$O(1)$。
