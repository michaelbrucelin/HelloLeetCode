### [三种方法：计数/位运算/数学（Python/Java/C++/Go/JS/Rust）](https://leetcode.cn/problems/find-missing-and-repeated-values/solutions/2569783/mo-ni-pythonjavacgo-by-endlesscheng-mexz/)
...
累加 $\textit{grid}$ 的所有元素的平方（$a^2$ 多加了一次，$b^2$ 少加了一次），再减去 $1$ 到 $n^2$ 的平方和，我们得到了 a2-b2a^2-b^2a2-b2，设计算出的结果为 $d_2$，则有
...
$$\begin{aligned} &a = \dfrac{d_2/d_1+d_1}{2}\\ &b = \dfrac{d_2/d_1-d_1}{2} \end{aligned}$$
