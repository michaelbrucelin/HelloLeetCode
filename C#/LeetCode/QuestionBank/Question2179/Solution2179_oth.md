### [转化成严格递增子序列 + 枚举中间 + 树状数组（Java/Python/C++/Go）](https://leetcode.cn/problems/count-good-triplets-in-an-array/solutions/1277695/deng-jie-zhuan-huan-shu-zhuang-shu-zu-by-xmyd/)
