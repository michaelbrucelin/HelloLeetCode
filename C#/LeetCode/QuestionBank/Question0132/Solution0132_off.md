### [分割回文串 II](https://leetcode.cn/problems/palindrome-partitioning-ii/solutions/641529/fen-ge-hui-wen-chuan-ii-by-leetcode-solu-norx/)
...
$$f[i]= \min\limits_{0 \le j<i}\{f[j]\}+1, 其中 s[j+1..i] 是一个回文串$$
...
>
> $$g(i,j)=\begin{cases}True, & i \ge j \\ g(i+1,j-1) \wedge (s[i]=s[j]), & otherwise​ \end{cases}$$
>
