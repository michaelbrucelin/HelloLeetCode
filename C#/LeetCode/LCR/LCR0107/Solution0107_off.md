### [矩阵中的距离](https://leetcode.cn/problems/2bCMpM/solutions/1412130/ju-zhen-zhong-de-ju-chi-by-leetcode-solu-0sxk/)
...
- 如果 $0$ 在矩阵中的位置是 $(i_0,j_0)$，1 在矩阵中的位置是 $(i_1,j_1)$，那么我们可以直接算出 $0$ 和 $1$ 之间的距离。因为我们从 $1$ 到 $0$ 需要在水平方向走 $\vert i_0-i_1\vert $ 步，竖直方向走 $\vert j_0-j_1\vert $ 步，那么它们之间的距离就为 $\vert i_0-i_1\vert +\vert j_0-j_1\vert $；
...
![](./assets/img/Solution0107_off_1.png)
...
$$f(i,j)=\begin{cases}1+min(f(i-1,j),f(i,j-1)), & 位置 (i,j) 的元素为 1 \\ 0, & 位置 (i,j) 的元素为 0\end{cases}$$
