### [二叉树最底层最左边的值](https://leetcode.cn/problems/LwUNpT/solutions/1614780/er-cha-shu-zui-di-ceng-zui-zuo-bian-de-z-0nlm/?envType=problem-list-v2&envId=ySsxoJfz)
...
- 空间复杂度：$O(n)$。如果二叉树是满完全二叉树，那么队列 $q$ 最多保存 $\lceil\dfrac{n}{2}\rceil$ 个节点。
