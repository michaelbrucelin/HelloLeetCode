### [只出现一次的数字](https://leetcode.cn/problems/WGki4K/solutions/1037537/zhi-chu-x_ian-yi-ci-de-shu-zi-by-leetcode-0vrt/?envType=problem-list-v2&envId=ySsxoJfz)
...
$$\begin{cases}a = (\sim a \& b \& x) | (a \& \sim b \& \sim x) \\ b = \sim a \& (b\enspace \^{}\enspace x)\end{cases}$$
...
$$\begin{cases}b = \sim a \& (b \enspace\^{}\enspace x) \\ a = \sim b \& (a \enspace\^{} \enspace x)\end{cases}$$
