...
> **输出：** `3`
> **解释：** 如下图所示： `rampart[0]` 向左侧膨胀 3 个单位； `rampart[2]` 向右侧膨胀 3 个单位； `rampart[1]` 向左侧膨胀 1 个单位，向右膨胀 2 个单位。 不存在膨胀更多的方案，返回 3。
> ![](./assets/img/Question0078.png)
...
- <code>3 <= rampart.length <= 10<sup>4</sup></code>
- `rampart[i].length == 2`
- <code>0 <= rampart[i][0] < rampart[i][1] <= rampart[i+1][0] <= 10<sup>8</sup></code>
