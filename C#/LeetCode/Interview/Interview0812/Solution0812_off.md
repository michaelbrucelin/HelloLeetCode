### [八皇后](https://leetcode.cn/problems/eight-queens-lcci/solutions/403802/ba-huang-hou-by-leetcode-solution/?envType=problem-list-v2&envId=ySsxoJfz)
...
![](./assets/img/Question0812_off_2_01.png)
...
![](./assets/img/Question0812_off_2_02.png)
...
![](./assets/img/Question0812_off_2_03.png)
![](./assets/img/Question0812_off_2_04.png)
![](./assets/img/Question0812_off_2_05.png)
![](./assets/img/Question0812_off_2_06.png)
![](./assets/img/Question0812_off_2_07.png)
![](./assets/img/Question0812_off_2_08.png)

每次放置皇后时，三个整数的按位或运算的结果即为不能放置皇后的位置，其余位置即为可以放置皇后的位置。可以通过 $(2n-1) \& (\sim (columns\vert diagonals_1\vert diagonals_2))$ 得到可以放置皇后的位置（该结果的值为 $1$ 的位置表示可以放置皇后的位置），然后遍历这些位置，尝试放置皇后并得到可能的解。
